...
<title>Penn State Football — Live Feed</title>
...
<body>
  <div class="container">
    <header class="header">
      <div class="brand">
        <img src="{{ url_for('static', filename='logo.png') }}" alt="Penn State" class="logo" />
        <div>
          <h1>Penn State Football — Live Feed</h1>
    ...
    <section class="controls">
      <input id="search" class="input" placeholder="Filter (e.g., Drew Allar, James Franklin)" />
